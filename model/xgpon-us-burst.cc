...
{
  //m_psbu.Print(os); ja:update:xgspon
...
XgponUsBurst::GetSerializedSize (void) const
{
  ...
  //ja:update:xgspon, need to update the len based on burst len (preamble and delimiter) and the xgtc-us-burst size
...
{
  //m_psbu.Serialize(start); ja:update:xgspon
...
{
  //m_psbu.Deserialize(start); ja:update:xgspon
