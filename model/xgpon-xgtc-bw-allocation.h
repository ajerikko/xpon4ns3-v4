...
//ja:update:xgspon the values in this class are verified to be the same for XGPON and XGSPON
...
private:
  ...
  uint16_t  m_grantSize;      //the size of this allocation. Len: 2 bytes. The unit of both start time and grant size is one block (4 Bytes in XGPON, 16 Bytes in XGSPON).
