...
{
public:
  const static uint16_t MAXIMAL_NODES_PER_XGPON = 1021;        //The maximal number of onus supported by the channel; ja:update:xgspon 1024 to 1021, meaning ONU-IDs going from 0 to 1020 as per G9807.1Amd2(10/2020).
