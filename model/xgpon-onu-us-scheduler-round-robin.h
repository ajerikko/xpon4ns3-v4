...
public:
  ...
  const static uint32_t XGPON1_US_PER_SERVICE_MAX_SIZE = 40000;  //40KBytes ja:update:xgspon for XGSPON, this is 160KBytes. If the XGSPON is simulated, the xgpon-helper sets the corresponding value 
