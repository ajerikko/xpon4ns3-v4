...
{
  NS_ASSERT_MSG(m_oltConnManager!=nullptr, "ConnManager has not been set yet.");
...
{
  NS_ASSERT_MSG(m_oltDsScheduler!=nullptr, "Downstream Scheduler has not been set yet.");
...
{
  NS_ASSERT_MSG(m_oltDbaEngine!=nullptr, "Dba Engine has not been set yet.");
...
{
  NS_ASSERT_MSG(m_oltPloamEngine!=nullptr, "Ploam Engine has not been set yet.");
...
{
  NS_ASSERT_MSG(m_oltFramingEngine!=nullptr, "Framing Engine has not been set yet.");
...
{
  NS_ASSERT_MSG(m_oltPhyAdapter!=nullptr, "Phy Adapter has not been set yet.");
...
{
  NS_ASSERT_MSG(m_oltXgemEngine!=nullptr, "Xgem engine has not been set yet.");
...
{
  NS_ASSERT_MSG(m_oltOmciEngine!=nullptr, "Omci engine has not been set yet.");
