...
{
  NS_ASSERT_MSG((m_onuConnManager!=nullptr), "ConnManager has not been set yet.");
...
{
  NS_ASSERT_MSG((m_onuDbaEngine!=nullptr), "Dba Engine has not been set yet.");
...
{
  NS_ASSERT_MSG((m_onuPloamEngine!=nullptr), "Ploam Engine has not been set yet.");
...
{
  NS_ASSERT_MSG((m_onuFramingEngine!=nullptr), "Framing Engine has not been set yet.");
...
{
  NS_ASSERT_MSG((m_onuPhyAdapter!=nullptr), "Phy Adapter has not been set yet.");
...
{
  NS_ASSERT_MSG((m_onuXgemEngine!=nullptr), "Xgem engine has not been set yet.");
...
{
  NS_ASSERT_MSG((m_onuOmciEngine!=nullptr), "Omci engine has not been set yet.");
